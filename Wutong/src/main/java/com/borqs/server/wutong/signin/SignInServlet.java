...
public class SignInServlet extends WebMethodServlet {
    ...
    public Record userSignIn(HttpServletRequest req, QueryParams qp) {
        ...
        if (!StringUtils.isBlank(loc)) {
            ...
            String post_id = p.postP(ctx, ctx.getViewerIdString(), SIGN_IN_POST, message, "[]", String.valueOf(APP_TYPE_BPC),
                    "", "", qp.getString("app_data", ""), "", false, "", "", ctx.getLocation(), "", "", true, true, true, "");
