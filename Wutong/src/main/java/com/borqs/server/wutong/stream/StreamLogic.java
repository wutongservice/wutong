...
public interface StreamLogic {
    ...
    String repostP(Context ctx, String userId, String mentions, boolean secretly, String postId, String newMessage, String device, String location, String appData, boolean can_comment, boolean can_like, boolean can_reshare, String add_to);

    boolean destroyPostsP(Context ctx, String userId, String postIds);

    String sendShareLinkP(Context ctx, String userId, String msg, String appId, String mentions, String app_data,
    ...
    String postP(Context ctx, String userId, Record post, List<String> emails, List<String> phones, String appId);
    ...
    String postP(Context ctx, String userId, int type, String msg, String attachments,
                 String appId, String packageName, String apkId,
                 String appData,
                 String mentions,
                 boolean secretly, String cols, String device, String location,
