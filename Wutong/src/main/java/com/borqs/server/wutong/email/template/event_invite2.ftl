...
<div id="body" style="height:auto; min-height:500px; border:0px solid; margin-top:2px; margin-left:2px; width:831px; background-image:url(http://storage.aliyun.com/wutong-data/system/event-notification-bg-.jpg);">
    ...
    <table width="100%" cellSpacing="0" cellPadding="0" align=center height=20 border=0>
        <tr>
            <td width=30%></td>
            <td width=20%><a href="${acceptUrl}"><input type=button value='Accept' style='background-image: url(http://storage.aliyun.com/wutong-data/system/accept_button_normal.png ); width:116px;height:39px;border: 0;background-repeat: no-repeat;'></a></td>
            <td width=20%><a href="${rejectUrl}"><input type=button value='No, thanks' style='background-image: url(http://storage.aliyun.com/wutong-data/system/thanks_button_normal.png ); width:116px;height:39px;border: 0;background-repeat: no-repeat;'></a></td>
