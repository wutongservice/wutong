...
//                type = Constants.PHOTO_POST;
            ...
            post_id = GlobalLogics.getStream().postP(ctx,viewerId, type, msg, commons.formatFileBucketUrlForStream(ctx,viewerId,rec).toString(false, false), qp.getString("appid", "1"),
