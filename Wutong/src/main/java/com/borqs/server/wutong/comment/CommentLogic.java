...
public interface CommentLogic {
    ...
    Record createCommentP(Context ctx, String userId, int objectType, String target, String message, String device, Boolean canLike, String location, String add_to, String appId) ;


    Record createComment1P(Context ctx, String userId, int objectType, String target, String message, String device, String location, String add_to, String appId) ;
