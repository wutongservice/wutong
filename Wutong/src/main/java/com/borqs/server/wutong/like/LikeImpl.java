...
//                    NotificationSender notif = new AppLikeNotifSender(this, null);
            ...
            if (objectType == Constants.APK_OBJECT) {
                ...
                if (send) {
                    ...
                    GlobalLogics.getStream().autoPost(ctx, userId, Constants.APK_LIKE_POST, sLike, tempNowAttachments, String.valueOf(Constants.APP_TYPE_QIUPU), "", target, "", "", false, Constants.QAPK_FULL_COLUMNS, device, location, true, true, true, "", "", false);
